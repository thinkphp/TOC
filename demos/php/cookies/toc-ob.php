...
function toc($content) {
    ...
    return str_replace('<div id="toc"><span id="contentheader">hide page contents</span></div>',$toc,$content);
}
...
<head>
  <title>Pur JavaScript TOC - my old nemesis</title>
  ...
  h2{color: #444}
  h3{color: #ccc}
  div#toc{position:fixed;top: 100px;left: 670px;width: 300px;border-top: 1px solid #ccc;border-bottom: 1px solid #ccc;z-index:4;font-family: helvetica,arial,verdana;background: #fff;font-size: 12px}
...
<script type="text/javascript" src="toc-dom.js"></script>
</body>
</html>
